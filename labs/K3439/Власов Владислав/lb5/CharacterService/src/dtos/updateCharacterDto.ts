...
import { UpdateCharacterDescrioptionDto } from "./updateCharacterDescrioptionDto"
...
export class UpdateCharacterDto {
    ...
    // @Type(() => UpdateCharacterDescrioptionDto)
    // description?: UpdateCharacterDescrioptionDto
}